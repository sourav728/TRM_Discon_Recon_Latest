...
public class ConstantValues {
    ...
    public static String SERVICE2 = "ReadFile.asmx/";
    ...
    public static String TEST_FTP_HOST = "45.114.246.216";
    ...
    public static final int FILE_UPLOADED = 55;
    public static final int FILE_UPLOADED_ERROR = 56;
