...
public class DateSelectActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        from_date = findViewById(R.id.txt_from_date);
        to_date = findViewById(R.id.txt_to_dtae);
        report = findViewById(R.id.btn_Report);
        fcall = new FunctionCall();
        img_from = findViewById(R.id.img_fromdate);
        img_to = findViewById(R.id.img_todate);
                ...
                if (fcall.isInternetOn(DateSelectActivity3.this)) {
                    if (!from_date.getText().toString().equals("")) {
                        if (!to_date.getText().toString().equals("")) {
                            ...
                            Toast.makeText(DateSelectActivity3.this, "Please Select To Date!!", Toast.LENGTH_SHORT).show();
                    } else
                        Toast.makeText(DateSelectActivity3.this, "Please Select From Date!!", Toast.LENGTH_SHORT).show();
                } else
                    Toast.makeText(DateSelectActivity3.this, "Please Turn on Internet!!", Toast.LENGTH_SHORT).show();
